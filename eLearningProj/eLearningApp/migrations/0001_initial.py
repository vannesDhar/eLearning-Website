# Generated by Django 4.2.6 on 2024-02-26 18:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='eLearningApp.user')),
            ],
        ),
        migrations.CreateModel(
            name='Feedback',
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eLearningApp.user')),
            ],
        ),
        migrations.CreateModel(
            name='Enrollment',
        ...
        migrations.AddField(
            model_name='course',
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eLearningApp.user'),
        ),
    ]
